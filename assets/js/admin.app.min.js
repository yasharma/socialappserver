...
mimicTrading.controller('userCtrl', ['$scope', '$state', '$rootScope', 'Upload', 'appSvr', function ($scope, $state, $rootScope, Upload, appSvr) {
   ...
   */
		if ($state.current.name === 'users') {
			...
			TableAjax.init({
				url: 'user/list',
				columns: [{ "data": "id", "orderable": false }, { "data": "customer_name" }, { "data": "business_name" }, { "data": "email" }, { "data": "mobile" }, { "data": "status" }, { "data": "created_date" }, { "data": "action", "orderable": false }]
			});
		}
	});
