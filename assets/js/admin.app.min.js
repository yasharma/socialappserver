...
mimicTrading.controller('paymentCtrl', ['$scope', '$state', 'appSvr', function ($scope, $state, appSvr) {
   ...
   */
		if ($state.current.name === 'payments') {
			...
			TableAjax.init({
				url: 'payment/list',
				columns: [{ "data": "id", "orderable": false }, { "data": "customer_name" }, { "data": "email" }, { "data": "amount" }, { "data": "balance_transaction" }, { "data": "description" }, { "data": "plan_name" }, { "data": "plan_price" }, { "data": "plan_description" }, { "data": "status" }, { "data": "created_date" }, { "data": "action", "orderable": false }]
			});
		}
	});
}]);
  ...
  */
	var paymentResolver = {
		payment: ['paymentSvr', '$stateParams', function (paymentSvr, $stateParams) {
			return paymentSvr.getUserById($stateParams.id);
		}]
	};
