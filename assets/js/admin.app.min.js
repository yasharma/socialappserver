...
mimicTrading.controller('homepageCreateCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'Upload', function ($scope, $state, RestSvr, $rootScope, appSvr, Upload) {
   ...
   */
	...
	$scope.new_homepage = function (isValid, data) {
		if (!isValid) {
			App.scrollTop();
			return;
		}
...
mimicTrading.controller('homepageViewCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'homepage', function ($scope, $state, RestSvr, $rootScope, appSvr, homepage) {
   ...
   */
	...
	$scope.goToEdit = function () {
		return $state.go('edithomepage', { slug: $state.params.slug });
	};
}]);
'use strict';
...
mimicTrading.config(['$stateProvider', function ($stateProvider) {
	...
	$stateProvider.state('newhomepage', {
		url: '/new-homepage',
