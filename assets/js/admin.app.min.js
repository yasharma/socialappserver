...
mimicTrading.controller('homepageCreateCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'Upload', 'homepage', function ($scope, $state, RestSvr, $rootScope, appSvr, Upload, homepage) {
