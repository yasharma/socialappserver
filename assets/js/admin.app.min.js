    ...
    */
	...
	$scope.forgotpassword = function () {
		...
		$http.post('adminapi/forgotpassword', inputjson).then(function (response) {
			App.alert({ type: 'info', icon: 'info', message: response.message, container: $rootScope.settings.errorContainer, place: 'prepend' });
			$state.go('login');
		}).catch(function (errors) {
			$scope.message = errors.message;
		}).then(function () {
...
mimicTrading.controller('resetPasswordCtrl', ['$scope', '$rootScope', '$http', '$state', function ($scope, $rootScope, $http, $state) {
