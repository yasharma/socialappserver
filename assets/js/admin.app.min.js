   ...
   */
		if ($state.current.name === 'subscriptions') {
			...
			TableAjax.init({
				...
				columns: [{ "data": "id", "orderable": false }, { "data": "name" }, { "data": "description" }, { "data": "price" }, { "data": "features" }, { "data": "duration" }, { "data": "status" }, { "data": "created_date" }, { "data": "action", "orderable": false }]
			});
		}
	});
