...
mimicTrading.controller('cmsCreateCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'cmsSvr', 'Upload', function ($scope, $state, RestSvr, $rootScope, appSvr, cmsSvr, Upload) {
   ...
   */
	...
	$scope._new_cms = function (isValid) {
		if (!isValid) {
			return;
		}
	...
	$scope.new_cms = function (isValid, _data) {
		if (!isValid) {
			App.scrollTop();
			return;
		}
...
mimicTrading.controller('cmsEditCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'cms', 'cmsSvr', 'Upload', function ($scope, $state, RestSvr, $rootScope, appSvr, cms, cmsSvr, Upload) {
   ...
   */
	...
	$scope.edit_cms = function (isValid, _data) {
		if (!isValid) {
			return;
		}
...
mimicTrading.controller('cmsLinkCreateCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', function ($scope, $state, RestSvr, $rootScope, appSvr) {
   ...
   */
	...
	$scope.new_cmsLink = function (isValid) {
		if (!isValid) {
			return;
		}

		$scope.isLoading = true;
		RestSvr.post('cmsLink/add', $scope.cmsLink).then(function (response) {
			$state.go('cmsLink');
		}).catch(function (errors) {
			App.alert({ type: 'danger', icon: 'warning', message: errors.message, container: $rootScope.settings.errorContainer, place: 'prepend' });
		}).then(function () {
...
mimicTrading.controller('cmsLinkCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', function ($scope, $state, RestSvr, $rootScope, appSvr) {
...
mimicTrading.controller('cmsLinkEditCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'cmsLink', function ($scope, $state, RestSvr, $rootScope, appSvr, cmsLink) {
   ...
   */
	...
	$scope.edit_cmsLink = function (isValid) {
		if (!isValid) {
			return;
		}

		$scope.isLoading = true;
		RestSvr.put('cmsLink/edit', $scope.cmsLink).then(function (response) {
			$state.go('cmsLink');
		}).catch(function (errors) {
			App.alert({ type: 'danger', icon: 'warning', message: errors.message, container: $rootScope.settings.errorContainer, place: 'prepend' });
		}).then(function () {
...
mimicTrading.controller('cmsLinkViewCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'cmsLink', function ($scope, $state, RestSvr, $rootScope, appSvr, cmsLink) {
   ...
   */
	...
	$scope.cmsLink = cmsLink.record;
	$scope.goToEdit = function () {
		return $state.go('editCmsLink', { id: $scope.cmsLink._id });
	};
}]);
'use strict';
...
angular.module('mimicTrading').controller('dashboardCtrl', ['$scope', '$location', '$rootScope', 'RestSvr', function ($scope, $location, $rootScope, RestSvr) {
	$scope.$on('$viewContentLoaded', function () {
	...
	RestSvr.get('userCount').then(function (_ref) {
		var record = _ref.record;
		return $scope.userCount = record.count;
	}).catch(function (errors) {
		return App.alert({ type: 'danger', icon: 'warning', message: errors.message, container: $rootScope.settings.errorContainer, place: 'prepend' });
	});

	RestSvr.get('subscriptionCount').then(function (_ref2) {
		var record = _ref2.record;
		return $scope.subscriptionCount = record.count;
	}).catch(function (errors) {
		return App.alert({ type: 'danger', icon: 'warning', message: errors.message, container: $rootScope.settings.errorContainer, place: 'prepend' });
	});

	RestSvr.get('paymentCount').then(function (_ref3) {
		var record = _ref3.record;
		return $scope.paymentCount = record.count;
	}).catch(function (errors) {
		return App.alert({ type: 'danger', icon: 'warning', message: errors.message, container: $rootScope.settings.errorContainer, place: 'prepend' });
	});
}]);
   ...
   */
	...
	$scope.open = function (action) {
		...
		modalInstance.result.then(function (selectedItem) {
			if (selectedItem) {
				homepageSvr.removeBannerImage(btoa(selectedItem)).then(function (response) {
					return $state.reload();
				}).catch(handleCatch);
			}
		}, function () {
...
mimicTrading.controller('paymentCtrl', ['$scope', '$state', 'appSvr', function ($scope, $state, appSvr) {
   ...
   */
		if ($state.current.name === 'payments') {
			...
			TableAjax.init({
				url: 'payment/list',
				columns: [{ "data": "id", "orderable": false }, { "data": "customer_name" }, { "data": "email" }, { "data": "amount" }, { "data": "plan_name" }, { "data": "status" }, { "data": "created_date" }, { "data": "action", "orderable": false }]
			});
		}
	});
}]);
...
mimicTrading.controller('paymentViewCtrl', ['$scope', '$state', 'payment', 'appSvr', function ($scope, $state, payment, appSvr) {
	$scope.$on('$viewContentLoaded', function () {
		/**
   * Initialize the jquery components when view contents loaded properly
   */
...
mimicTrading.controller('subscriptionCtrl', ['$scope', '$state', '$rootScope', 'Upload', 'appSvr', 'RestSvr', function ($scope, $state, $rootScope, Upload, appSvr, RestSvr) {
	$scope.subscription = {};
   ...
   */
		if ($state.current.name === 'subscriptions') {
			...
			TableAjax.init({
				...
				columns: [{ "data": "id", "orderable": false }, { "data": "name" }, { "data": "description" }, { "data": "price" }, { "data": "features" }, { "data": "type" }, { "data": "status" }, { "data": "created_date" }, { "data": "action", "orderable": false }]
			});
		}
	});
...
mimicTrading.controller('subscriptionEditCtrl', ['$scope', '$state', 'subscription', 'Upload', 'appSvr', '$rootScope', function ($scope, $state, subscription, Upload, appSvr, $rootScope) {
	$scope.$on('$viewContentLoaded', function () {
		/**
   * Initialize the jquery components when view contents loaded properly
   */
...
mimicTrading.controller('subscriptionViewCtrl', ['$scope', '$state', 'subscription', 'appSvr', function ($scope, $state, subscription, appSvr) {
	$scope.$on('$viewContentLoaded', function () {
		/**
   * Initialize the jquery components when view contents loaded properly
   */
...
mimicTrading.controller('userCtrl', ['$scope', '$state', '$rootScope', 'Upload', 'appSvr', 'RestSvr', function ($scope, $state, $rootScope, Upload, appSvr, RestSvr) {
   ...
   */
		if ($state.current.name === 'users') {
			...
			TableAjax.init({
				url: 'user/list',
				columns: [{ "data": "id", "orderable": false }, { "data": "customer_name" }, { "data": "customer_url" }, { "data": "email" }, { "data": "mobile" }, { "data": "status" }, { "data": "created_date" }, { "data": "action", "orderable": false }]
			});
		}
	});
...
mimicTrading.config(['$stateProvider', function ($stateProvider) {
	...
	var cmsLinkResolver = ['cmsLinkSvr', '$stateParams', function (cmsLinkSvr, $stateParams) {
		return cmsLinkSvr.getCmsLinkById($stateParams.id);
	}];

	$stateProvider.state('cmsLink', {
		url: '/cms-links',
...
mimicTrading.config(['$stateProvider', function ($stateProvider) {
  ...
  */
	var paymentResolver = {
		payment: ['paymentSvr', '$stateParams', function (paymentSvr, $stateParams) {
			return paymentSvr.getPaymentById($stateParams.id);
		}]
	};
...
mimicTrading.config(['$stateProvider', function ($stateProvider) {
  ...
  */
	var subscriptionResolver = {
		subscription: ['subscriptionSvr', '$stateParams', function (subscriptionSvr, $stateParams) {
			return subscriptionSvr.getSubscriptionById($stateParams.id);
		}]
	};
...
mimicTrading.factory('cmsLinkSvr', ['RestSvr', function (RestSvr) {
    return {
        getCmsLinkById: function getCmsLinkById(id) {
            return RestSvr.get('cmsLink/view/' + id);
        }
    };
}]);
'use strict';
...
mimicTrading.factory('homepageSvr', ['RestSvr', function (RestSvr) {
    return {
        ...
        removeBannerImage: function removeBannerImage(_id) {
            return RestSvr.delete('homepage/remove_banner/' + _id);
        }
    };
}]);
'use strict';
...
mimicTrading.factory('paymentSvr', ['RestSvr', function (RestSvr) {
    return {
        getPaymentById: function getPaymentById(id) {
            return RestSvr.get('payment/view/' + id);
        }
    };
}]);
'use strict';
...
mimicTrading.factory('subscriptionSvr', ['RestSvr', function (RestSvr) {
    return {
        getSubscriptionById: function getSubscriptionById(id) {
            return RestSvr.get('subscription/view/' + id);
        }
    };
}]);
'use strict';
...
mimicTrading.factory('RestSvr', ['$http', '$window', '$httpParamSerializerJQLike', '$q', function ($http, $window, $httpParamSerializerJQLike, $q) {
	return {
		...
		delete: function _delete(apiUrl, params) {
			var p = !angular.isUndefined(params) ? params : null,
			    req = {
				method: 'DELETE',
				url: baseUrl(apiUrl),
