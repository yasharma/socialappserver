...
mimicTrading.controller('termsconditionsCreateCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'termsconditionsSvr', function ($scope, $state, RestSvr, $rootScope, appSvr, termsconditionsSvr) {
   ...
   */
	...
	$scope.new_termscondition = function (isValid) {
		if (!isValid) {
			return;
		}

		$scope.isLoading = true;
		RestSvr.post('termsconditions/add', $scope.termsconditions).then(function (response) {
...
mimicTrading.controller('termsconditionsCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', function ($scope, $state, RestSvr, $rootScope, appSvr) {
...
mimicTrading.controller('termsconditionsEditCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'termsconditions', 'termsconditionsSvr', function ($scope, $state, RestSvr, $rootScope, appSvr, termsconditions, termsconditionsSvr) {
   ...
   */
	...
	$scope.edit_termsconditions = function (isValid) {
		if (!isValid) {
			return;
		}

		$scope.isLoading = true;
		RestSvr.put('termsconditions/edit', $scope.termsconditions).then(function (response) {
			$state.go('termsconditions');
		}).catch(function (errors) {
			App.alert({ type: 'danger', icon: 'warning', message: errors.message, container: $rootScope.settings.errorContainer, place: 'prepend' });
		}).then(function () {
...
mimicTrading.controller('termsconditionsViewCtrl', ['$scope', '$state', 'RestSvr', '$rootScope', 'appSvr', 'termsconditions', function ($scope, $state, RestSvr, $rootScope, appSvr, termsconditions) {
   ...
   */
	...
	$scope.termsconditions = termsconditions.record;
	$scope.goToEdit = function () {
		return $state.go('editTermsConditions', { id: $scope.termsconditions.id });
	};
}]);
'use strict';
...
mimicTrading.config(['$stateProvider', function ($stateProvider) {
	...
	var termsconditionsResolver = ['termsconditionsSvr', '$stateParams', function (termsconditionsSvr, $stateParams) {
		return termsconditionsSvr.getTermsConditionsById($stateParams.id);
	}];
...
mimicTrading.factory('termsconditionsSvr', ['RestSvr', function (RestSvr) {
    return {
        getTermsConditionsById: function getTermsConditionsById(id) {
            return RestSvr.get('termsconditions/view/' + id);
        },
